...
public class StargateNetworkRecipeProvider extends FabricRecipeProvider {
    ...
    public StargateNetworkRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    private Identifier getStonecuttingIdentifier(Block in, Block out) {
        return StargateNetwork.id(fixupBlockKey(in.getTranslationKey()) + "_to_" + fixupBlockKey(out.getTranslationKey()) + "_stonecutting");
    }
